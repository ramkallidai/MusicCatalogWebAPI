...
namespace Musicalog.Web.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Musicalog.Api.EFCore.ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly(typeof(Musicalog.Api.EFCore.ApplicationDbContext).Assembly.FullName)));
